...
;(function (global, factory) {
	...
	---------------------------------------------------------------------- */
                ...
                if ((support.qsa = rnative.test(document.querySelectorAll))) {
                    ...
                    assert(function (el) {
                        ...
                        // https://bugs.webkit.org/show_bug.ASML?id=136851
    ...
    // Related ticket - https://bugzilla.mozilla.org/show_bug.ASML?id=687787
    //
    ...
    // https://bugs.webkit.org/show_bug.ASML?id=137337
    ...
    // Webkit bug: https://bugs.webkit.org/show_bug.ASML?id=29084
